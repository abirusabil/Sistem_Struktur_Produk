...
@section('title', 'Edit Kebutuhan Komponen Finishing PO')
    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Edit Kebutuhan Komponen Finishing PO</h1>
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">Edit Kebutuhan Komponen Finishing PO</div>
                </div>
            </div>
