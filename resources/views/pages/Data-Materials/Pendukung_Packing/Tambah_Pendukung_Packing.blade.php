            ...
            <div class="section-body">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="/Pendukung_Packing" method="POST">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="Nama_Pendukung_Packing" id="Nama_Pendukung_Packing" class="form-control @error('Nama_Pendukung_Packing') is-invalid @enderror" value="{{ old('Nama_Pendukung_Packing') }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="Satuan_Pendukung_Packing" id="Satuan_Pendukung_Packing" class="form-control @error('Satuan_Pendukung_Packing') is-invalid @enderror">
                                            ...
                                            <option value="Meter" {{ old('Satuan_Pendukung_Packing') == 'Meter' ? 'selected' : '' }}>Meter</option>
                                            <option value="Pcs" {{ old('Satuan_Pendukung_Packing') == 'Pcs' ? 'selected' : '' }}>Pcs</option>
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" step="0.01" name="Harga_Pendukung_Packing" id="Harga_Pendukung_Packing" class="form-control @error('Harga_Pendukung_Packing') is-invalid @enderror" value="{{ old('Harga_Pendukung_Packing') }}">
