                            ...
                            <div class="card-body">
                                <form action="/Item" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="Warna_Item" id="Warna_Item" class="form-control @error('Warna_Item') is-invalid @enderror" value="{{ old('Warna_Item') }}">
                                        @error('Warna_Item')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group mb-3">
                                        ...
                                        <select name="Collection_Id" id="Collection_Id" class="form-control">
                                            ...
                                            @foreach ($collections as $collection)
                                                <option value="{{ $collection->id }} " {{ old('Collection_Id') == $collection->id ? 'selected' : '' }}>{{ $collection->Nama_Collection }}</option>
                                            @endforeach
                                        </select>     
                                    </div>
