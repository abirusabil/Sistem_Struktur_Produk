                            ...
                            <div class="card-body">
                                <form action="/Collection/{{ $Collection->id }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="id" id="id" class="form-control @error('id') is-invalid @enderror" value="{{ old('id',$Collection->id) }}">
                                        @error('id')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="Nama_Collection" id="Nama_Collection" class="form-control @error('Nama_Collection') is-invalid @enderror" value="{{ old('Nama_Collection',$Collection->Nama_Collection) }}">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select name="Buyer_Id" id="Buyer_Id" class="form-control">
                                            ...
                                            @if (old('Buyer_Id',$Collection->Buyer_Id) == $buyer->id)
