...
@section('main')
    <div class="main-content">
        <section class="section">
            ...
            @if (count($Accessories_Hardware) >= 1 ) 
                <div class="Accessories_Hardware">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5>Accessories Hardware</h5>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        @if (session()->has('success'))
            ...
            {{-- Komponen_Finishing --}}
            @if (count($Komponen_Finishing) >= 1 ) 
                <div class="Komponen_Finishing">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5>Komponen Finishing</h5>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        @if (session()->has('success'))
            ...
            {{-- End Komponen_Finishing --}}
             ...
             {{-- Pendukung_Packing --}}
            @if (count($Pendukung_Packing) >= 1 )
                <div class="Pendukung_Packing">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5>Pendukung Packing</h5>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        @if (session()->has('success'))
