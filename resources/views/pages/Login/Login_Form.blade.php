...
<div class="d-flex flex-wrap align-items-stretch">
    ...
    <div class="col-lg-8 col-12 order-lg-2 order-1 min-vh-100 background-walk-y position-relative overlay-gradient-bottom login-page" data-background="/img/unsplash/login-bg.jpg">
      <div class=" index-2">
      </div>
    </div>
  </div>
